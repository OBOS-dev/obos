...
typedef enum vma_flags
{
	...
	VMA_FLAGS_32BITPHYS = BIT(8), // 32-bit physical addresses should be allocated. Best to use with VMA_FLAGS_NON_PAGED. Ignored if file != nullptr.
    VMA_FLAGS_OVERWRITE = BIT(9), // Overwrite the page mappings. TODO:
