...
file(DOWNLOAD
	https://github.com/UltraOS/Hyper/releases/download/v0.12.0/hyper_iso_boot
	${CMAKE_SOURCE_DIR}/dependencies/hyper/hyper_iso_boot
)
file(DOWNLOAD
	https://github.com/UltraOS/Hyper/releases/download/v0.12.0/BOOTX64.EFI
...
if (CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows" OR CMAKE_HOST_SYSTEM_NAME STREQUAL "MSYS")
	...
	file(DOWNLOAD
		https://github.com/UltraOS/Hyper/releases/download/v0.12.0/hyper_install-win64.exe
		${hyper_install}
	)
elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
	...
	file(DOWNLOAD
		https://github.com/UltraOS/Hyper/releases/download/v0.12.0/hyper_install-linux-x86_64
		${hyper_install}
	)
else()
...
FetchContent_Declare(UltraProtocol
	...
	GIT_TAG db30db897d0da7c48d4d630a1367c4a588791191
